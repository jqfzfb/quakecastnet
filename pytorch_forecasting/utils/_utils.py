...
from lightning.pytorch.callbacks.callback import Callback as PLCallback

class WarmupSchedulerCallback(PLCallback):
    def __init__(self, total_steps, warmup_fraction=0.03):
